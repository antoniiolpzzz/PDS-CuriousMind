...
Click [_here_](https://github.com/antoniiolpzzz/PDS-CuriousMind/issues?q=is%3Aissue+is%3Aclosed+label%3Ause-case) to go to our detailed use cases list, including:
